...
const MapPlaceholder: React.FC<{ className?: string }> = ({
  ...
  return (
    <div
      className={`w-full page-px ${className}`}
      role="status"
      aria-live="polite"
      aria-label="Loading map"
    >
      <div className="h-[240px] md:h-[400px] lg:h-[450px] w-full rounded-media border border-header-stroke bg-2nd-bg overflow-hidden relative">
